...
import 'package:myapp/app/services/ingredient_service.dart';
...
class _AddIngredientScreenState extends State<AddIngredientScreen> {
      ...
      try {
        if (_selectedIngredientId == null) {
          ...
          if (_selectedIngredientForEdit == null) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                  content: Text('Error: Data bahan untuk diedit tidak ditemukan.'),
                  backgroundColor: Colors.red),
            );
            return;
          }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(_selectedIngredientId == null
    ...
    const SizedBox(height: 16),
      ...
      TextFormField(
        ...
        decoration: const InputDecoration(
          ...
          prefixIcon: Icon(Icons.square_foot_outlined), // Ganti ikon jika ada yang lebih cocok
        ),
        validator: (value) {
          if (value == null || value.trim().isEmpty) {
      ...
      SizedBox(
        ...
        child: ElevatedButton.icon(
          icon: Icon(_selectedIngredientId == null ? Icons.add : Icons.save),
          label: Text(_selectedIngredientId == null ? 'Simpan Bahan' : 'Update Bahan'),
      ...
      StreamBuilder<List<Ingredient>>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            print("Error StreamBuilder: ${snapshot.error}"); // Untuk debugging
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          if (ingredient.id != null) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Error: ID bahan tidak ditemukan untuk dihapus.'), backgroundColor: Colors.red),
                            );
                          }
                        },
                      ),
                  ...
                  onTap: () => _populateFormForEdit(ingredient), // Bisa juga untuk edit
                ),
              );
            },
          );
